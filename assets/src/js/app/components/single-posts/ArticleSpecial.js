...
class ArticleSpecial extends Component {
    ...
    render() {
        ...
        return (
            <section className="article special">
                <div className="special-hero">
                    <div className={`thumbnail-container ${meta.hide_thumbnail_on_single ? 'wo-thumb' : ''}`}>
                        <ArticleNavigation {...articleNavigationProps}/>
                        {!meta.hide_thumbnail_on_single && <Thumbnail thumbnails={thumbnails}/>}
                        {(thumbnails.caption && !meta.hide_thumbnail_on_single) && <p className="caption mobile">{thumbnails.caption}</p>}
                        <ArticleTitle toContent {...articleTitleProps}/>
                    </div>
