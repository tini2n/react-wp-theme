...
class Initialization extends AbstractInitialization {
	...
	public function register_custom_post_types() {
		$post_type = new PostType( Functions::POST_TYPE, __( 'Order', TEXT_DOMAIN ), [
			'name'               => __( 'Order', TEXT_DOMAIN ),
			'singular_name'      => __( 'Order', TEXT_DOMAIN ),
			'add_new'            => __( 'Add Order', TEXT_DOMAIN ),
			'add_new_item'       => __( 'New Order', TEXT_DOMAIN ),
